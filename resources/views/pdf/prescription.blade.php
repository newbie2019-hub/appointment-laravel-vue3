...
<body>
    ...
    <p class="font-lg">PRESCRIPTION</p>
    <pre class="font-lg">{{ $prescription->prescription }}</pre>
    <p class="font-lg">ADDITIONAL NOTE</p>
    <pre class="font-lg">{{ $prescription->note }}</pre>
    <p class="mt-5">Patient is advised to take this prescription to prevent any further implications</p>
    <p>This prescription is issued by the doctor and is generated by the system automatically.</p>
    <h4 class="mt-5  mb-none">Dental Doctor,</h4>
    <h3 class=" font-regular">Dr. Joana Marie Manabat-Flores</h3>
