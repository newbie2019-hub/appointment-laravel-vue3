...
<body>
        ...
        <tbody>
            <tr>
                ...
                <td class="pl-0 border-0">
                    ...
                    <p>Generated On: <strong>{{ $invoice->getDate() }}</strong></p>
                </td>
            </tr>
        </tbody>
    </table>
    ...
    <table class="table table-items">
        ...
        <tbody>
            ...
            <tr>
                <td colspan="{{ $invoice->table_columns - 2 }}" class="border-0"></td>
                <td class="pl-0 text-right">{{ __('invoices::invoice.amount_tendered') }}</td>
                <td class="pr-0 text-right total-amount">
                    {{ $invoice->formatCurrency($invoice->amount_tendered) }}
                </td>
            </tr>
            <tr>
                <td colspan="{{ $invoice->table_columns - 2 }}" class="border-0"></td>
            ...
            <tr>
                <td colspan="{{ $invoice->table_columns - 2 }}" class="border-0"></td>
                @if ($invoice->total_amount > $invoice->amount_tendered)
                    <td class="pl-0 text-right">Balance</td>
                @else
                    <td class="pl-0 text-right">{{ __('invoices::invoice.change') }}</td>
                @endif
                <td class="pr-0 text-right total-amount">
