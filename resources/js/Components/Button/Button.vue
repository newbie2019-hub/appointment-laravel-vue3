...
<template>
  <button
    ...
    :type="type"
    :disabled="disabled"
    class="disabled:bg-gray-200 duration-200 items-center ease-in-out font-medium inline-flex rounded uppercase focus:ring-2 ring-offset-2 text-white ml-2 tracking-wider disabled:cursor-not-allowed"
    :class="cssClass"
  >
    <slot />
  </button>
