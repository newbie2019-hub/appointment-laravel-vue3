...
const initialPrescription = { appointment_id: null, prescription: '', note: '' }
    ...
    <BreezeAuthenticatedLayout>
                ...
                <div class="flex-1 p-4 text-white bg-red-500 rounded-md">
                    <div class="flex justify-between">
                        ...
                        <div class="flex flex-col items-end gap-y-8">
                            ...
                            <p class="font-medium leading-5 tracking-wider text-right uppercase">Trashed
                                <br />Appointments
                            </p>
                        </div>
                    </div>
                ...
                <div class="flex-1 p-4 text-white bg-green-600 rounded-md">
                    <div class="flex justify-between">
                        ...
                        <div class="flex flex-col items-end gap-y-8">
                            ...
                            <p class="font-medium leading-5 tracking-wider text-right uppercase">Total
                                <br />Appointments
                            </p>
                        </div>
                    </div>
                ...
                <div class="flex-1 p-4 text-white bg-blue-600 rounded-md">
                    <div class="flex justify-between">
                        ...
                        <div class="flex flex-col items-end gap-y-8">
                            ...
                            <p class="font-medium leading-5 tracking-wider text-right uppercase">Today's
                                <br />Appointments
                            </p>
                        </div>
                    </div>
                ...
                <div class="overflow-x-auto sm:rounded-lg">
                    <div class="">
                        <div class="pb-6 mx-auto bg-white border-gray-200 rounded-lg max-w-8xl sm:px-6 lg:px-8">
                            ...
                            <div class="flex justify-between mb-6 mt-7 gap-x-2">
                                ...
                                <div class="flex gap-x-2">
                                    <Button @click.prevent="
                                      isCreating = true;
                                      toggleCreateModal();
                                    " size="sm" color="success">Add Appointment</Button>
                                ...
                                <table class="min-w-full divide-y divide-gray-300">
                                    <thead class="bg-gray-50">
                                        <tr class="[&>*]:uppercase font-medium text-xs text-gray-500">
                                            ...
                                            <th scope="col"
                                                class="py-3.5 pl-4 pr-3 text-left sm:pl-6 whitespace-nowrap">Status</th>
                                            <th scope="col"
                                                class="py-3.5 pl-4 pr-3 text-left sm:pl-6 whitespace-nowrap">Patient
                                            </th>
                                            <th scope="col"
                                                class="py-3.5 pl-4 pr-3 text-left sm:pl-6 whitespace-nowrap">Email</th>
                                            <th scope="col"
                                                class="py-3.5 pl-4 pr-3 text-left sm:pl-6 whitespace-nowrap">Schedule
                                            </th>
                                            <th scope="col"
                                                class="py-3.5 pl-4 pr-3 text-left sm:pl-6 whitespace-nowrap">Message
                                            </th>
                                            <th scope="col"
                                                class="py-3.5 pl-4 pr-3 text-left sm:pl-6 whitespace-nowrap">Sub Total
                                            </th>
                                            <th scope="col"
                                                class="py-3.5 pl-4 pr-3 text-left sm:pl-6 whitespace-nowrap">Payment
                                                Type</th>
                                            <th scope="col"
                                                class="py-3.5 pl-4 pr-3 text-left sm:pl-6 whitespace-nowrap">Payment
                                            </th>
                                            <th scope="col"
                                                class="py-3.5 pl-4 pr-3 text-left sm:pl-6 whitespace-nowrap">Created On
                                            </th>
                                            <th scope="col"
                                                class="py-3.5 pl-4 pr-3 text-left sm:pl-6 whitespace-nowrap">Deleted On
                                            </th>
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        <tr v-for="(appointment, i) in appointments.data" :key="i"
                                            ...
                                            <td
                                                class="py-4 pl-4 pr-3 text-sm font-medium text-gray-900 whitespace-nowrap sm:pl-6">
                                                <Chip :label="appointment.appointment_status"
                                                    :color="chipColor(appointment.appointment_status)" />
                                            </td>
                                            <td
                                                class="py-4 pl-4 pr-3 text-sm font-medium text-gray-900 whitespace-nowrap sm:pl-6">
                                                {{
                                            ...
                                            <td
                                                class="py-4 pl-4 pr-3 text-sm font-medium text-gray-900 whitespace-nowrap sm:pl-6">
                                                {{
                                                appointment.patient.email }}</td>
                                            <td
                                                class="py-4 pl-4 pr-3 text-sm font-medium text-gray-900 whitespace-nowrap sm:pl-6">
                                                {{
                                                appointment.schedule }}</td>
                                            <td class="py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6">{{
                                            stringLimit(appointment.message) }}</td>
                                            <td
                                                class="py-4 pl-4 pr-3 text-sm font-medium text-gray-900 whitespace-nowrap sm:pl-6">
                                                {{
                                                formatCurrency(appointment.subtotal) }}</td>
                                            <td
                                                class="py-4 pl-4 pr-3 text-sm font-medium text-gray-900 whitespace-nowrap sm:pl-6">
                                            ...
                                            <td
                                                class="py-4 pl-4 pr-3 text-sm font-medium text-gray-900 whitespace-nowrap sm:pl-6">
                                                <Chip :label="appointment.payment_status"
                                                    :color="chipColor(appointment.payment_status)" />
                                            </td>
                                            <td
                                                class="py-4 pl-4 pr-3 text-sm font-medium text-gray-900 whitespace-nowrap sm:pl-6">
                                                {{
                                                appointment.created_at }}</td>
                                            <td
                                                class="py-4 pl-4 pr-3 text-sm font-medium text-gray-900 whitespace-nowrap sm:pl-6">
                                                {{
                                                appointment.deleted_at }}</td>
                                            <td class="relative py-4 pl-3 pr-4 text-sm whitespace-nowrap sm:pr-6">
                                                <Button text size="sm" @click="
                                                  toggleAppointmentModal();
                                                ...
                                                <Button is-link
                                                    ...
                                                    :href="route('invoice.generate', appointment.id)" text size="sm"
                                                    color="success">View
                                                    Receipt</Button>
                                                ...
                                                <Button
                                                    ...
                                                    @click.prevent="
                                                      ...
                                                      selectedAppointment = { ...appointment };
                                                    " text size="sm" color="">Payment</Button>
                                                <Button v-if="!appointment.deleted_at" @click.prevent="
                                                  toggleDeleteModal();
                                                  selectedAppointment = appointment;
                                                " text size="sm" color="error">Trash</Button>
                                            </td>
                                        </tr>
                                        <tr v-if="appointments.data.length == 0">
                                            <td colspan="11">
                                                <div class="py-4 mx-auto font-medium text-center text-gray-600">No data
                                                    available ..</div>
                                            </td>
                                        </tr>
                                    </tbody>
                            ...
                            <p class="mt-2 text-sm text-gray-500">Showing {{ appointments.from ?? 0 }} to {{
                            appointments.to ?? 0 }}
                                out of {{ appointments.total ?? 0 }} appointments.</p>
        ...
        <Modal v-if="isAppointmentModalShown" @close="toggleAppointmentModal">
            ...
            <template v-slot:body>
                ...
                <p class="text-sm" v-for="services in selectedAppointment.services" :key="services.id">{{
                services.service.service }} - {{ formatCurrency(services.service.price) }}</p>
            </template>
            <template v-slot:footer>
                ...
                " @click.prevent="finishedAppointment" text size="sm" color="success">Mark as Finished</Button>
                <Button v-if="
                ...
                " @click.prevent="approveAppointment" text size="sm" color="success">Approve</Button>
            </template>
        </Modal>
        ...
        <Modal v-if="isDeleteModalShown" @close="toggleDeleteModal">
            ...
            <template v-slot:body>
                <p class="text-sm text-gray-600">Are you sure you want to move this appointment to trash? Once moved to
                    trash
                    the appointment status will be marked as cancelled and cannot be restored.</p>
            </template>
            <template v-slot:footer>
        ...
        <Modal v-if="isPrescriptionModalShown" @close="togglePrescriptionModal">
            <template v-slot:title>
                ...
                <p class="text-sm font-regular">Enter your prescription for this appointment</p>
            </template>
            <template v-slot:body>
                <form action="" class="mt-2">
                    <form-input label="Prescription" for="prescription" class="mt-3" :error="errors.prescription">
                        <floating-text-area v-model="prescriptionData.prescription" id="prescription" required
                            aria-required />
                    </form-input>
                    <form-input label="Additional Note" for="prescription-additional" class="mt-3" :error="errors.note">
                        <floating-text-area v-model="prescriptionData.note" id="prescription-additional" required
                            aria-required />
                    </form-input>
                </form>
            </template>
            <template v-slot:footer>
                <Button @click.prevent="togglePrescriptionModal" text size="sm" color="gray">Close</Button>
                <Button @click.prevent="generatePrescription" text size="sm" color="success">Save</Button>
            </template>
        </Modal>
        ...
        <Modal v-if="isPaymentModalShown" @close="toggleStripePaymentModal">
            ...
            <template v-slot:body>
                ...
                <form-input for="payment_fname" :error="errors.schedule" label="Full Name" class="mt-1 mb-3">
                    <floating-input disabled type="text" id="payment_fname"
                        v-model="selectedAppointment.patient.full_name" aria-disabled />
                </form-input>
                <form-input for="payment_fname" :error="errors.schedule" label="Address" class="mt-3 mb-3">
                    <floating-text-area type="text" id="payment_fname" v-model="selectedAppointment.patient.address"
                        disabled aria-disabled />
                </form-input>
            </template>
            <template v-slot:footer>
                <Button @click.prevent="toggleStripePaymentModal" text size="sm" color="gray">Close</Button>
                <Button @click.prevent="processPayment" text size="sm" color="success" :disabled="isBtnLoading">{{
                !isBtnLoading
                ? 'Proceed' : 'Processing..' }}</Button>
            </template>
        </Modal>
        ...
        <Modal v-if="isBranchPaymentModalShown" @close="toggleBranchPaymentModal">
            ...
            <template v-slot:body>
                ...
                <form-input for="subtotal" :error="errors.subtotal" label="Subtotal" class="mt-3 mb-3">
                    <floating-input type="number" id="subtotal" v-model="selectedAppointment.subtotal" disabled
                        aria-disabled />
                </form-input>
            </template>
            <template v-slot:footer>
                <Button @click.prevent="toggleBranchPaymentModal" text size="sm" color="gray">Close</Button>
                <Button @click.prevent="processBranchPayment" text size="sm" color="success" :disabled="isBtnLoading">{{
                !isBtnLoading ? 'Proceed Payment' : 'Processing..' }}</Button>
            </template>
        </Modal>
        ...
        <Modal v-if="isCreateModalShown" @close="toggleCreateModal">
            ...
            <template v-slot:body>
                <form class="flex flex-col">
                    ...
                    <VueMultiselect v-model="form.selected_services" :options="services" :multiple="true"
                        class="border-2 border-gray-500 rounded-lg" selectLabel="Select" deselectLabel="Deselect"
                        label="service" track-by="id">
                    ...
                    <p v-if="errors.selected_services" class="mt-1 text-sm text-red-500">{{ errors.selected_services }}
                    </p>
                    <div v-if="$page.props.auth.user.is_admin">
                        <p class="mt-2 text-sm">Select Patient</p>
                        <VueMultiselect v-model="form.user_id" @search-change="searchPatient" :options="users"
                            :multiple="false" class="border-2 border-gray-500 rounded-lg" selectLabel="Select"
                            deselectLabel="Deselect" label="full_name" track-by="id" :disabled="!isCreating">
                        </VueMultiselect>
        ...
        <Modal v-if="isRestoreModalShown" @close="toggleRestoreModal">
            ...
            <template v-slot:body>
                <p class="text-sm text-gray-600">Are you sure you want to restore this scheduled appointment? This might
                    cause
                    conflicts to some of the schedules.</p>
            </template>
            <template v-slot:footer>
